...
class PipelineController:
    ...
    def __init__(self, base_path: str = None):
        ...
        # Pipeline stages configuration v6.0.0 - STRATEGIC OPTIMIZATION APPLIED
        self.stages = [
            ...
            {'id': '06b_statistical_analysis_post',
             'name': 'Statistical Analysis (Post-Cleaning)', 'critical': False},
            ...
            {'id': '08_sentiment_analysis', 'name': 'Sentiment Analysis',
             'critical': False},
            {'id': '08_5_hashtag_normalization',
             'name': 'Hashtag Normalization (Optimized Position)', 'critical': False},
            {'id': '09_topic_modeling', 'name': 'Topic Modeling (Voyage.ai - Parallel)',
             'critical': False},
            {'id': '10_tfidf_extraction',
             'name': 'TF-IDF Extraction (Voyage.ai - Parallel)', 'critical': False},
            {'id': '11_clustering', 'name': 'Clustering (Voyage.ai - Parallel)',
             'critical': False},
            {'id': '12_domain_analysis', 'name': 'Domain Analysis',
             'critical': False},
            {'id': '13_temporal_analysis', 'name': 'Temporal Analysis',
             'critical': False},
            {'id': '14_network_analysis', 'name': 'Network Analysis',
             'critical': False},
            {'id': '15_qualitative_analysis', 'name': 'Qualitative Analysis',
             'critical': False},
            {'id': '16_smart_pipeline_review',
             'name': 'Smart Pipeline Review', 'critical': False},
            {'id': '17_topic_interpretation',
             'name': 'Topic Interpretation', 'critical': False},
            {'id': '18_semantic_search',
             'name': 'Semantic Search (Voyage.ai - Cached)', 'critical': False},
            {'id': '19_pipeline_validation', 'name': 'Pipeline Validation',
             'critical': True}
        ]
