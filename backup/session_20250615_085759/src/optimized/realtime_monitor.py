...
def get_global_realtime_monitor() -> PerformanceMonitor:
    """Factory function for global realtime monitor - alias for get_global_performance_monitor"""
    return get_global_performance_monitor()